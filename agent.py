...
#from numpy import random ##*** Newly Added ***##
...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #Nisha -> decay function -0.02  For Improved  Learning
            #self.epsilon = math.exp(-0.02*self.trial)
            
            #Nisha ->  decay function -0.2 For Basic /Default Learning
            #self.epsilon = math.exp(-0.2*self.trial)
            
            #Nisha ->  decay function -0.05 For Default Learning
                if self.epsilon > 0:
